...
def predict(args):
    ...
    for exp in test_image_list:
        ...
        plt.subplot(5, 1, 1)
        plt.plot(all_y[...,0],'black')
        plt.plot(all_y_pred[...,0],'green')
        #plt.legend(['Target', 'Pred'], loc="upper center",ncol=2,frameon=False)
        plt.xlim([-50,len(all_class) + 50])
        plt.xlabel('frame')
        plt.ylabel('steer X')
        
        plt.subplot(5, 1, 2)   
        plt.plot(all_y[...,1],'black')
        plt.plot(all_y_pred[...,1],'blue')
        #plt.legend(['Target', 'Pred'], loc="upper center",ncol=2,frameon=False)
        ...
        plt.subplot(5, 1, 3)   
        plt.plot(perror,'black')
        #plt.legend(['Steering error'], loc="upper center",frameon=False)
        ...
        plt.subplot(5, 1, 4)   
        plt.plot(all_class,'black')

        plt.legend(['Target'], loc="upper center",frameon=False)
        plt.xlim([-50,len(all_class) + 50])
        plt.xlabel('frame')
        plt.ylabel('class')
        
        plt.subplot(5, 1, 5)   
        plt.plot(all_class_pred,'red')
        #plt.legend(['Pred'], loc="upper center",frameon=False)
        plt.xlim([-50,len(all_class) + 100])
        plt.xlabel('frame')
        plt.ylabel('class')
