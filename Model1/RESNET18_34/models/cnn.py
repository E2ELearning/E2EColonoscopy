...
class CNN(nn.Module):
    def __init__(self,args):
        ...
        self.regressorF = nn.Linear(resnet.fc.in_features, 128)
        self.regressor = nn.Linear(128, self.output_size)
        
        self.classifierF = nn.Linear(resnet.fc.in_features, 128)
    ...
    def forward(self, x):
        ...
        x_coor = self.regressorF(x)
        x_coor =F.relu(x_coor )
        coordinate=self.regressor(x_coor)
