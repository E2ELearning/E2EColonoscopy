...
def parse_args():
    ...
    # parser.add_argument('--model', type=str,
    #                     help='select model in (cnn | cnnlstm)', default = 'cnnlstm')
    
    parser.add_argument('--model', type=str,
                        help='select model in (cnn | cnnlstm )', default = 'cnn_gression')
    
    parser.add_argument('--dataset', type=str,
                        help='path to dataset', default = r'/home/rc/Desktop/syfile2023/Thesisdata2023_newChangeName')

    
    parser.add_argument('--model_name', type=str,
                        help='path to saving model', default = './4VRes34ep30bz256LR0d00001DR05')
